...
static void calculate_separation(struct boid *boid, size_t idx,
                                 const struct boid *boids, size_t boids_count) {
    float close_dx = 0;
    float close_dy = 0;
...
static void calculate_alignment(struct boid *boid, size_t idx,
                                const struct boid *boids, size_t boids_count) {
    float xvel_avg = 0;
    float yvel_avg = 0;
...
static void calculate_cohesion(struct boid *boid, size_t idx,
                               const struct boid *boids, size_t boids_count) {
    float xpos_avg = 0;
    float ypos_avg = 0;
...
static void calculate_edge_avoidance(struct boid *boid, uint32_t window_width,
